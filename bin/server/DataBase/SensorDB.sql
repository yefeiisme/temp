...
CREATE TABLE `sensor` (
  ...
  `AvgValue1` double DEFAULT '0',
  `AvgValue2` double DEFAULT '0',
  `AvgValue3` double DEFAULT '0',
  `OffsetValue1` double DEFAULT '0',
  `OffsetValue2` double DEFAULT '0',
  `OffsetValue3` double DEFAULT '0',
