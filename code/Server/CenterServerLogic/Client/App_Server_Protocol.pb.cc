...
const ::std::string& S2App_Login_Result_ServerData::port() const {
  // @@protoc_insertion_point(field_get:APP_SERVER_NET_Protocol.S2App_Login_Result.ServerData.port)
  return port_.GetNoArena();
}
void S2App_Login_Result_ServerData::set_port(const ::std::string& value) {
  set_has_port();
...
#if LANG_CXX11
void S2App_Login_Result_ServerData::set_port(::std::string&& value) {
  set_has_port();
  port_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
#endif
void S2App_Login_Result_ServerData::set_port(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_port();
...
void S2App_Login_Result_ServerData::set_port(const void* value, size_t size) {
  set_has_port();
...
::std::string* S2App_Login_Result_ServerData::mutable_port() {
  set_has_port();
...
::std::string* S2App_Login_Result_ServerData::release_port() {
...
void S2App_Login_Result_ServerData::set_allocated_port(::std::string* port) {
  if (port != NULL) {
    set_has_port();
  } else {
    clear_has_port();
